...
/* Start of snippet added for South Pacific compatibility */
#ifdef DOMJUDGE
...
/* End of snippet added for South Pacific compatibility */
...
NORETURN void InStream::quit(TResult result, const char* msg)
{
    ...
    // South Pacific Change. Do not output anything to stderr
    //std::fprintf(stderr, "\n");
...
/* South Pacific modifications to end of function */
    inf.init(argv[1], _input);
